# import sys
# file_abs_path = "D:\Columbia\finBERT-master"
...
# python scripts/predict.py --text_path WSJ_Articles_AA.txt --output_dir output/ --model_path models/classifier_model/finbert-sentiment
# export PYTHONPATH="$PYTHONPATH:D:\Columbia\finBERT-master"